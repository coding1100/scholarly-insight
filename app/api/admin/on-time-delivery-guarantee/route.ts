...
export async function POST(request: NextRequest) {
  try {
    console.log('POST /api/admin/on-time-delivery-guarantee - Starting save operation');
    ...
    // For on-time-delivery-guarantee page, always use on-time-delivery-guarantee as id
    const query = { 
      id: "on-time-delivery-guarantee"
    };
