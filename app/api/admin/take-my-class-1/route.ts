...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Querying pages collection for take-my-class-1, query:', JSON.stringify(query));
...
export async function POST(request: NextRequest) {
  try {
    console.log('POST /api/admin/take-my-class-1 - Starting save operation');
    ...
    // For take-my-class-1 page, always use take-my-class-1 as id and pageType
    const query = { 
      $or: [
        { id: "take-my-class-1" },
        { pageType: "take-my-class-1" }
